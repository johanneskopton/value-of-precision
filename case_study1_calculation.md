...
![a) Probability distribution for imprecise dosage. b) Graphical representation of the calculation for the Expected Value of Perfect Precision (EVPP) as the difference between profits given precise and imprecise dosage.](imgs/synplot2.png)
...
$$
The integral was solved using the excellent open source Computer Algebra System *Maxima* [@maxima].
